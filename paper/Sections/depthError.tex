...
\begin{figure*}
\centering
\makebox[\textwidth][c]{\includegraphics[scale=0.5,trim={0.05cm 0.5cm 0.5cm 1cm},clip]{/Users/gail/Documents/Research/Projects/Layers/paper/figures/radargram-4layers-paper}}
%\captionsetup{width=.9\textwidth}
