...
%\end{table}
 ...
 \begin{table}
 \centering
 \caption{ \textbf{VALUES NEED TO BE UPDATED.} Depth and age mean, median, and uncertainty for ten strong radar reflectors near Byrd Station, West Antarctica. The radar two-way travel time (TWTT) is given in column 1. }
...
% %& ($\mu$s)& Mean & Median & $\sigma$ & & Mean & Median & $\sigma$ \\
 ...
 \cline{3-4} \cline{6-7}
  ...
  2 & 12.54   & 880.8  &  7.4 & &2100 & 60   \\
  3 & 17.55   & 1300.7 &  6.1 & &3510 & 150  \\
  4 & 22.42   & 1711.9 &  4.4 & &4360 & 200  \\
